      ...
      <div class="profile_container">
        ...
        <?php else: ?>
          <div class="banner_and_avatar_container">
            ...
            <a href="change-profile-banner.php?user_identity=<?php if (isset($encode_id)) {echo $encode_id;} ?>"><span class="glyphicon glyphicon-edit" id="edit_banner_glyphicon"></span></a>
            <div class="profile_picture_container">
              ...
              <a href="change-profile-picture.php?user_identity=<?php if (isset($encode_id)) {echo $encode_id;} ?>"><span class="glyphicon glyphicon-edit" id="edit_avatar_glyphicon"></span></a>
            </div>
          </div>
